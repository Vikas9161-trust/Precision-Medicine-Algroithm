...
def test_save():
    with Session(engine) as session:
        try:
            print("Testing ClinicalRecord save with mental health fields...")
            ...
            print("Testing Appointment save with notes...")
            appt = Appointment(
                patient_name="Test User 002",
                ...
                notes="Patient has concerns about Warfarin dosage."
            )
            session.add(appt)
            session.commit()
